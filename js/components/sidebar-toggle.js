...
export function initSidebarToggle() {
  ...
  const sidebar = document.getElementById('mainSidebar') || document.querySelector('.sidebar, .u-sidebar');
  const backdrop = document.getElementById('backdrop') || document.querySelector('.sidebar-backdrop');
